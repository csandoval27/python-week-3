...
print(
    f'{name} liked to hum the song {song} while coding. It was so annoying that their teammates would throw {food} until {name} would stop singing'
)
# Still, [name] was the best coder on the team and could write [number] lines of code every day. Maybe [song] was [name]’s secret power?
print(
    f'still, {name} was the best coder on the team and could write {number} lines of code every day. Maybe {song} was {name}s secret power?'
)
##########################################################################################
...
age_of_hancockHighSchool = input("How old is hancock high school?")
#print out the age of hancock high school and your age in a sentence
print(
    f'hancock high school is {age_of_hancockHighSchool} years old and you are {age} years old'
)
